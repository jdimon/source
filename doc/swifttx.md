...
This mechanism has been integrated into Bitcore-Node-Graphcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Graphcoin/insight-api-graphcoin#web-socket-api](https://github.com/Graphcoin/insight-api-graphcoin#web-socket-api) 
* API: [https://github.com/Graphcoin/insight-api-graphcoin#swifttx-transactions](https://github.com/Graphcoin/insight-api-graphcoin#swifttx-transactions) 
...
By default, the Graphcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Graphcoin Core daemon:
